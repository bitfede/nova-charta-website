...
function QuattroSezioni() {
  ...
  return (
    <div className={styles.quattroSezioniContainer}>
      <Row>
        <Col xs="12" lg="6">
          <a className={`${styles.cardLinkElem} ${styles.hvrShrink}`} target="_blank" href="http://www.novacharta.it/categoria-prodotto/abbonamenti/">
        ...
        <Col xs="12" lg="6">
          <a className={`${styles.cardLinkElem} ${styles.hvrShrink}`} target="_blank" href="http://www.novacharta.it/categoria-prodotto/collana-cimelia/">
        ...
        <Col xs="12" lg="6">
          <a className={`${styles.cardLinkElem} ${styles.hvrShrink}`} target="_blank" href="#">
